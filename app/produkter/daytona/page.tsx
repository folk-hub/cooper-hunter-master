...
export default function DaytonaPage() {
  const product = getProductById("daytona")
  ...
  const ambientImages = [
    "/images/daytona-vinter-mork.webp",
    "/images/daytona-skandinavisk-sommer.webp",
    "/images/daytona-soverom-sommer.webp",
    "/images/daytona-treningsrom-sommer.jpg",
    "/images/daytona-vinter-hytte.webp",
  ]
  const ambientLabels = ["Hytta", "Stuen", "Soverommet", "Treningsrommet", "Hytta"]

  const handleDownload = () => {
    const link = document.createElement("a")
    link.href = "/produktark/daytona-produktark.pdf"
    link.download = "Cooper&Hunter Daytona-produktark.pdf"
    link.click()
  }
        ...
        <section className="pb-12 md:pb-16">
          <div className="container">
            <div className="relative overflow-hidden rounded-3xl h-[320px] md:h-[420px]">
              <Image
                src="/images/daytona-vinter-mork.jpg"
